from sqlalchemy import Boolean, Column, Date, DateTime, ForeignKey, Integer, String, Text, Sequence
...
class Areas(Base):
    ...
    id = Column(Integer, Sequence('areas_id_seq'), primary_key=True)
...
class TaskPriorities(Base):
    ...
    id = Column(Integer, Sequence('task_priorities_id_seq'), primary_key=True)
    priority = Column(String(100), nullable=False)

class Types(Base):
    __tablename__ = 'types'

    id = Column(Integer, Sequence('types_id_seq'), primary_key=True)
...
class RolesPermissions(Base):
    ...
    id = Column(Integer, Sequence('roles_permissions_id_seq'), primary_key=True)
...
class Actions(Base):
    ...
    id = Column(Integer, Sequence('actions_id_seq'), primary_key=True)
    type_id = Column(ForeignKey('types.id'), nullable=False)
...
class ProjectNotifications(Base):
    ...
    id = Column(Integer, Sequence('project_notifications_id_seq'), primary_key=True)
    project_id = Column(ForeignKey('projects.id'), nullable=False)
...
class UsersNotifications(Base):
    ...
    id = Column(Integer, Sequence('users_notifications_id_seq'), primary_key=True)
    noti_id = Column(ForeignKey('notifications.id'), nullable=False)
    user_id = Column(ForeignKey('users.id'), nullable=False)
...
class UsersProjects(Base):
    ...
    id = Column(Integer, Sequence('users_projects_id_seq'), primary_key=True)
    user_id = Column(ForeignKey('users.id'), nullable=False)
    project_id = Column(ForeignKey('projects.id'), nullable=False)
    role_id = Column(ForeignKey('roles.id'), nullable=False)
...
class ChatsMessages(Base):
    ...
    id = Column(Integer, Sequence('chats_messages_id_seq'), primary_key=True)
...
class Requests(Base):
    ...
    id = Column(Integer, Sequence('requests_id_seq'), primary_key=True)
    user_id = Column(ForeignKey('users.id'), nullable=False)
    project_id = Column(ForeignKey('projects.id'), nullable=False)
...
class TaskFiles(Base):
    ...
    id = Column(Integer, Sequence('task_files_id_seq'), primary_key=True)
...
class TaskRequirements(Base):
    ...
    id = Column(Integer, Sequence('task_requirements_id_seq'), primary_key=True)
    task_id = Column(ForeignKey('tasks.id'), nullable=False)
...
class UsersTasks(Base):
    ...
    id = Column(Integer, Sequence('users_tasks_id_seq'), primary_key=True)
    user_id = Column(ForeignKey('users.id'), nullable=False)
    task_id = Column(ForeignKey('tasks.id'), nullable=False)
...
class ChatFiles(Base):
    ...
    id = Column(Integer, Sequence('chat_files_id_seq'), primary_key=True)
